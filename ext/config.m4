...
if test "$PHP_YUGA" = "yes"; then
	...
	for dir in "yuga yuga/application yuga/container yuga/container/support yuga/http yuga/http/input yuga/interfaces/application yuga/interfaces/http/input yuga/support"; do
