...
PHP_METHOD(Yuga_Guid, create)
{
	...
	ZVAL_LONG(&_5, 0);
	ZVAL_LONG(&_6, 65535);
	ZEPHIR_CALL_FUNCTION(&_7, "mt_rand", &_8, 46, &_5, &_6);
	zephir_check_call_status();
	ZVAL_LONG(&_5, 0);
	ZVAL_LONG(&_6, 65535);
	ZEPHIR_CALL_FUNCTION(&_9, "mt_rand", &_8, 46, &_5, &_6);
	zephir_check_call_status();
	ZVAL_LONG(&_5, 0);
	ZVAL_LONG(&_6, 65535);
	ZEPHIR_CALL_FUNCTION(&_10, "mt_rand", &_8, 46, &_5, &_6);
	zephir_check_call_status();
	ZVAL_LONG(&_5, 16384);
	ZVAL_LONG(&_6, 20479);
	ZEPHIR_CALL_FUNCTION(&_11, "mt_rand", &_8, 46, &_5, &_6);
	zephir_check_call_status();
	ZVAL_LONG(&_5, 32768);
	ZVAL_LONG(&_6, 49151);
	ZEPHIR_CALL_FUNCTION(&_12, "mt_rand", &_8, 46, &_5, &_6);
	zephir_check_call_status();
	ZVAL_LONG(&_5, 0);
	ZVAL_LONG(&_6, 65535);
	ZEPHIR_CALL_FUNCTION(&_13, "mt_rand", &_8, 46, &_5, &_6);
	zephir_check_call_status();
	ZVAL_LONG(&_5, 0);
	ZVAL_LONG(&_6, 65535);
	ZEPHIR_CALL_FUNCTION(&_14, "mt_rand", &_8, 46, &_5, &_6);
	zephir_check_call_status();
	ZVAL_LONG(&_5, 0);
	ZVAL_LONG(&_6, 65535);
	ZEPHIR_CALL_FUNCTION(&_15, "mt_rand", &_8, 46, &_5, &_6);
	zephir_check_call_status();
...
PHP_METHOD(Yuga_Guid, encrypt)
{
	...
	ZEPHIR_CALL_FUNCTION(&_3, "hash", NULL, 47, &_2, key, &__$true);
	zephir_check_call_status();
	ZVAL_LONG(&_4, 0);
	ZVAL_LONG(&_5, 16);
	ZEPHIR_INIT_NVAR(key);
	zephir_substr(key, &_3, 0 , 16 , 0);
	ZEPHIR_CALL_FUNCTION(&_6, "openssl_cipher_iv_length", NULL, 48, method);
	zephir_check_call_status();
	ZEPHIR_CALL_FUNCTION(&iv, "openssl_random_pseudo_bytes", NULL, 39, &_6);
	zephir_check_call_status();
	ZVAL_LONG(&_7, 0);
	ZEPHIR_CALL_FUNCTION(&_8, "openssl_encrypt", NULL, 49, data, method, key, &_7, &iv);
	zephir_check_call_status();
	ZEPHIR_CPY_WRT(data, &_8);
	ZEPHIR_CALL_FUNCTION(&_8, "bin2hex", NULL, 38, &iv);
	zephir_check_call_status();
	ZEPHIR_INIT_VAR(&_9);
	ZEPHIR_CONCAT_VSV(&_9, data, "|", &_8);
	ZEPHIR_RETURN_CALL_FUNCTION("base64_encode", NULL, 50, &_9);
	zephir_check_call_status();
	RETURN_MM();
}
...
PHP_METHOD(Yuga_Guid, decrypt)
{
	...
	ZEPHIR_INIT_NVAR(key);
	zephir_substr(key, &_3, 0 , 16 , 0);
	ZEPHIR_CALL_FUNCTION(&_6, "base64_decode", NULL, 51, data);
	zephir_check_call_status();
	...
	ZEPHIR_CALL_FUNCTION(&binary, "hex2bin", NULL, 52, &iv);
	zephir_check_call_status();
	if (ZEPHIR_IS_FALSE(&binary)) {
		RETURN_MM_BOOL(0);
	}
	ZVAL_LONG(&_7, 0);
	ZEPHIR_CALL_FUNCTION(&_8, "openssl_decrypt", NULL, 53, data, method, key, &_7, &binary);
	zephir_check_call_status();
	ZEPHIR_CPY_WRT(data, &_8);
...
PHP_METHOD(Yuga_Guid, generateSalt)
{
	...
	ZEPHIR_CALL_FUNCTION(&_0, "mt_rand", NULL, 46);
	zephir_check_call_status();
	ZEPHIR_CALL_FUNCTION(&_1, "uniqid", NULL, 54, &_0, &__$true);
	zephir_check_call_status();
	ZEPHIR_INIT_VAR(&_2);
	ZVAL_STRING(&_2, "2y");
	ZEPHIR_RETURN_CALL_FUNCTION("password_hash", NULL, 55, &_1, &_2);
	zephir_check_call_status();
	RETURN_MM();
}
