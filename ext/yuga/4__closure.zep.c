...
{
	ZEPHIR_REGISTER_CLASS(yuga, 4__closure, yuga, 4__closure, yuga_4__closure_method_entry, ZEND_ACC_FINAL_CLASS);
...
PHP_METHOD(yuga_4__closure, __invoke)
{
	...
	ZEPHIR_RETURN_CALL_FUNCTION("urlencode", NULL, 103, &_0);
