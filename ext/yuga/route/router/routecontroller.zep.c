...
PHP_METHOD(Yuga_Route_Router_RouteController, hasName)
{
	...
	if (!ZEPHIR_IS_FALSE_IDENTICAL(&_2)) {
		...
		ZVAL_STRING(&_3$$4, ".");
		ZEPHIR_CALL_FUNCTION(&_4$$4, "strrpos", &_5, 98, name, &_3$$4);
		zephir_check_call_status();
		...
		ZVAL_STRING(&_3$$4, ".");
		ZEPHIR_CALL_FUNCTION(&_7$$4, "strrpos", &_5, 98, name, &_3$$4);
		zephir_check_call_status();
		ZVAL_LONG(&_8$$4, 0);
...
PHP_METHOD(Yuga_Route_Router_RouteController, findUrl)
{
	...
	if (!ZEPHIR_IS_FALSE_IDENTICAL(&_1)) {
		...
		ZVAL_STRING(&_2$$3, ".");
		ZEPHIR_CALL_FUNCTION(&_3$$3, "strrpos", NULL, 98, name, &_2$$3);
		zephir_check_call_status();
		...
		ZEPHIR_CALL_FUNCTION(&found$$3, "array_search", NULL, 99, &_2$$3, &_5$$3, &__$false);
		zephir_check_call_status();
...
PHP_METHOD(Yuga_Route_Router_RouteController, matchRoute)
{
	...
	if (zephir_fast_count_int(&path) > 0) {
		...
		ZVAL_LONG(&_16$$4, 1);
		ZEPHIR_CALL_FUNCTION(&_17$$4, "array_slice", NULL, 100, &path, &_16$$4);
		zephir_check_call_status();
