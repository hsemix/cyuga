...
PHP_METHOD(Yuga_Route_Route, group)
{
	...
	ZEPHIR_CALL_METHOD(NULL, &group, "setcallback", NULL, 82, callback);
	zephir_check_call_status();
	ZEPHIR_CALL_METHOD(NULL, &group, "setsettings", NULL, 83, &settings);
	zephir_check_call_status();
...
PHP_METHOD(Yuga_Route_Route, match)
{
	...
	ZEPHIR_CALL_METHOD(NULL, &route, "__construct", NULL, 72, url, callback);
	zephir_check_call_status();
	ZEPHIR_CALL_METHOD(NULL, &route, "setrequestmethods", NULL, 84, &requestMethods);
	zephir_check_call_status();
	ZEPHIR_CALL_SELF(&_0, "adddefaultnamespace", NULL, 0, &route);
	zephir_check_call_status();
	ZEPHIR_CPY_WRT(&route, &_0);
	if (!ZEPHIR_IS_NULL(&settings)) {
		ZEPHIR_CALL_METHOD(NULL, &route, "setsettings", NULL, 85, &settings);
		zephir_check_call_status();
	}
	ZEPHIR_CALL_SELF(&_0, "router", NULL, 0);
	zephir_check_call_status();
...
PHP_METHOD(Yuga_Route_Route, error)
{
	...
	ZEPHIR_CALL_METHOD(NULL, &group, "addexceptionhandler", NULL, 88, &callbackException);
	zephir_check_call_status();
	ZEPHIR_MAKE_REF(&routes);
	ZEPHIR_CALL_FUNCTION(NULL, "array_unshift", NULL, 89, &routes, &group);
	ZEPHIR_UNREF(&routes);
	zephir_check_call_status();
...
PHP_METHOD(Yuga_Route_Route, resources)
{
	...
	ZEPHIR_CALL_METHOD(NULL, &route, "__construct", NULL, 90, url, controller);
	zephir_check_call_status();
	ZEPHIR_CALL_SELF(&_0, "adddefaultnamespace", NULL, 0, &route);
	zephir_check_call_status();
	ZEPHIR_CPY_WRT(&route, &_0);
	if (!ZEPHIR_IS_NULL(&settings)) {
		ZEPHIR_CALL_METHOD(NULL, &route, "setsettings", NULL, 91, &settings);
		zephir_check_call_status();
	}
	ZEPHIR_CALL_SELF(&_0, "router", NULL, 0);
	zephir_check_call_status();
...
PHP_METHOD(Yuga_Route_Route, router)
{
	...
	if (Z_TYPE_P(&_0) == IS_NULL) {
		...
		ZEPHIR_CALL_METHOD(NULL, &_1$$3, "__construct", NULL, 92);
		zephir_check_call_status();
	...
	if (EG(exception)) {
		...
		if (zephir_is_instance_of(&_1, SL("Exception"))) {
			...
			/* try_start_2: */
				...
				ZVAL_STRING(&_2$$5, "/");
				ZEPHIR_CALL_METHOD(NULL, return_value, "__construct", NULL, 93, &_2$$5);
...
PHP_METHOD(Yuga_Route_Route, response)
{
	...
	if (Z_TYPE_P(&_0) == IS_NULL) {
		...
		zephir_check_call_status();
		ZEPHIR_CALL_METHOD(NULL, &_3$$3, "__construct", NULL, 94, &_4$$3);
		zephir_check_call_status();
		ZEPHIR_CALL_METHOD(NULL, &_1$$3, "__construct", NULL, 95, &_2$$3, &_3$$3);
		zephir_check_call_status();
