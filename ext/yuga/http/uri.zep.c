...
PHP_METHOD(Yuga_Http_Uri, __construct)
{
	...
	if (_0) {
		...
		if (zephir_array_isset_string(&data$$3, SL("query")) == 1) {
			...
			ZEPHIR_CALL_FUNCTION(NULL, "parse_str", NULL, 48, &_8$$11, &params$$11);
...
PHP_METHOD(Yuga_Http_Uri, hasParam)
{
	...
	ZEPHIR_CALL_METHOD(&_0, this_ptr, "getparams", NULL, 0);
	zephir_check_call_status();
	ZEPHIR_RETURN_CALL_FUNCTION("\in_array", NULL, 67, name, &_0, &__$true);
	zephir_check_call_status();
	RETURN_MM();
}
...
PHP_METHOD(Yuga_Http_Uri, removeParam)
{
	...
	if (ZEPHIR_IS_TRUE_IDENTICAL(&_0)) {
		...
		zephir_check_call_status();
		ZEPHIR_CALL_FUNCTION(&key$$3, "\array_search", NULL, 68, name, &params$$3, &__$true);
		zephir_check_call_status();
...
PHP_METHOD(Yuga_Http_Uri, parseUrl)
{
	...
	ZEPHIR_INIT_VAR(&_0);
	ZEPHIR_INIT_NVAR(&_0);
	zephir_create_closure_ex(&_0, NULL, yuga_3__closure_ce, SL("__invoke"));
	ZEPHIR_INIT_VAR(&_1);
	ZVAL_STRING(&_1, "/[^:\\/@?&=#]+/u");
	ZEPHIR_CALL_FUNCTION(&encodedUrl, "preg_replace_callback", NULL, 69, &_1, &_0, url);
	zephir_check_call_status();
	ZEPHIR_CALL_FUNCTION(&parts, "parse_url", NULL, 70, &encodedUrl, component);
	zephir_check_call_status();
	...
	ZEPHIR_RETURN_CALL_FUNCTION("array_map", NULL, 61, &_1, &parts);
	zephir_check_call_status();
	RETURN_MM();
}
...
PHP_METHOD(Yuga_Http_Uri, arrayToParams)
{
	...
	if (!ZEPHIR_IS_NULL(&getParams)) {
		if (ZEPHIR_IS_FALSE_IDENTICAL(includeEmpty)) {
			...
			zephir_create_closure_ex(&_0$$4, NULL, yuga_4__closure_ce, SL("__invoke"));
			ZEPHIR_CALL_FUNCTION(&_1$$4, "array_filter", NULL, 6, &getParams, &_0$$4);
			zephir_check_call_status();
			ZEPHIR_CPY_WRT(&getParams, &_1$$4);
		}
		ZEPHIR_RETURN_CALL_FUNCTION("http_build_query", NULL, 71, &getParams);
		zephir_check_call_status();
		RETURN_MM();
	}
	RETURN_MM_STRING("");
