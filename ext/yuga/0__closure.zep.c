...
ZEPHIR_INIT_CLASS(yuga_0__closure)
{
	...
	zend_declare_property_null(yuga_0__closure_ce, SL("original"), ZEND_ACC_PUBLIC|ZEND_ACC_STATIC);
	zend_declare_property_null(yuga_0__closure_ce, SL("index"), ZEND_ACC_PUBLIC|ZEND_ACC_STATIC);
	return SUCCESS;
}
...
PHP_METHOD(yuga_0__closure, __invoke)
{
	...
	ZEPHIR_MM_GROW();
	zephir_read_static_property_ce(&index, yuga_0__closure_ce, SL("index"), PH_NOISY_CC);
	zephir_read_static_property_ce(&original, yuga_0__closure_ce, SL("original"), PH_NOISY_CC);
	...
	ZEPHIR_CALL_FUNCTION(&fileValues, "array_values", NULL, 1, &index);
