...
{
	ZEPHIR_REGISTER_CLASS(yuga, 2__closure, yuga, 2__closure, yuga_2__closure_method_entry, ZEND_ACC_FINAL_CLASS);

	zend_declare_property_null(yuga_2__closure_ce, SL("original"), ZEND_ACC_PUBLIC|ZEND_ACC_STATIC);
	zend_declare_property_null(yuga_2__closure_ce, SL("index"), ZEND_ACC_PUBLIC|ZEND_ACC_STATIC);
	return SUCCESS;
}
...
PHP_METHOD(yuga_2__closure, __invoke)
{
	...
	ZEPHIR_MM_GROW();
	zephir_read_static_property_ce(&index, yuga_2__closure_ce, SL("index"), PH_NOISY_CC);
	zephir_read_static_property_ce(&original, yuga_2__closure_ce, SL("original"), PH_NOISY_CC);
