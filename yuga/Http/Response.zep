...
class Response
{
    ...
    {
        var httpModified, httpIfNoneMatch;
        this->headers([
        ...
        let httpModified = this->request->getHeader("http-if-modified-since");
        let httpIfNoneMatch = this->request->getHeader("http-if-none-match");
