...
class InputFile implements InputItemInterface
{
    ...
    public function __construct(index)
    {
        ...
        let this->name = ucfirst(str_replace("_", " ", this->index));
    }
    ...
    {
        var file;
        let file = explode('.', basename(this->getFilename()));
        return end(file);
    }
